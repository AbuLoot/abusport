...
class CreatedNewMatchByDate extends Event implements ShouldBroadcast
{
    ...
    {
        return ['area-'.$this->match->field->area_id.'_date-'.$this->match->date];
    }
