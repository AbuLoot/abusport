...
class EpayController extends Controller
{
    public function index()
    {
        ...
        $path1 = [
            ...
            'PUBLIC_KEY_FN' => storage_path() . '\payment\epay\paysys\kkbca.pem',
        ...
        $content = process_request($payment->id,$currency_id, $payment->amount, $path1); // Возвращает подписанный и base64 кодированный XML документ для отправки в банк


        return view('payment.epay.paytest.pay', compact('user', 'content'));
    }
