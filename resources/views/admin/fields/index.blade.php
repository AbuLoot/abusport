...
@section('content')
    ...
    <p class="text-right">
      <a href="/admin/fields/create" class="btn btn-success btn-sm">Добавить</a>
    </p>
        ...
        <tbody>
          ...
          @forelse ($fields as $field)
            <tr>
              ...
              @endif
              <td class="text-right">
                <a class="btn btn-primary btn-xs" href="{{ route('admin.fields.edit', $field->id) }}" title="Редактировать"><span class="glyphicon glyphicon-edit"></span></a>
                <form method="POST" action="{{ route('admin.fields.destroy', $field->id) }}" accept-charset="UTF-8" class="btn-delete">
