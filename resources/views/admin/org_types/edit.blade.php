        ...
        <div class="panel-body">
          ...
          <form action="{{ route('admin.org_types.update', $org_type->id) }}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="short_title" name="short_title" minlength="5" maxlength="80" value="{{ (old('short_title')) ? old('short_title') : $org_type->short_title }}" required>
            </div>
            <div class="form-group">
